...
<main class="background-auth">
	<div class="auth-container-color">
		<div class="container">
		    ...
		    <form method="POST" action="{{ URL::route('user.invite.doSignUp', array($user->slug, $contact->id)) }}" role="form" class="form-login margin-top-normal">
		                    ...
		                    <div class="form-group">
		                        ...
		                        @elseif ($key == 'level_id')
		                            {{ Form::select('level_id'
		                               ...
		                               , array('class' => 'form-control')) }}
		                        @else
		                            {{ Form::text($key, $contact->{$key}, ['class' => 'form-control', 'readonly']) }}
		                        @endif
		                    </div>
		                </div>
		            </div>
