...
var ProfileQuestionsTableEditable = function () {
    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            $.ajax({
                url: "{{ URL::route('company.profile.async.saveQuestion') }}",
                dataType : "html",
                type : "POST",
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('company.profile.async.deleteQuestion') }}",
                dataType : "json",
                type : "POST",
...
var TemplatesTableAdvanced = function () {
    ...
    var initTable = function () {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('company.profile.async.deleteVITemplate') }}",
                dataType : "json",
                type : "POST",
...
var QuestionnaireTableAdvanced = function () {
    ...
    var initTable3 = function () {
        ...
        table.on('click', '.delete', function (e) {
            ...
            $.ajax({
                url: "{{ URL::route('company.profile.async.deleteQuestionnaire') }}",
                dataType : "json",
                type : "POST",
...
function saveVITemplate(obj) {
    ...
    $.ajax({
        url: "{{ URL::route('company.profile.async.saveVITemplate') }}",
        dataType : "json",
        type : "POST",
...
function saveQuestionnaire(obj) {
    ...
    $.ajax({
        url: "{{ URL::route('company.profile.async.saveQuestionnaire') }}",
        dataType : "json",
        type : "POST",
