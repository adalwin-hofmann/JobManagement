...
$('button#js-btn-update-member').click(function(event) {
	...
	if (name == '' || email == '') {
        ...
        $.ajax({
            url: "{{ URL::route('agency.user.async.updateMember') }}",
            dataType : "json",
            type : "POST",
...
$('button#js-btn-add-member').click(function() {
	...
	if (name == '' || email == '') {
        ...
        $.ajax({
            url: "{{ URL::route('agency.user.async.addMember') }}",
            dataType : "json",
            type : "POST",
...
function showView(obj) {
	...
	if (super_target == "div#div_apply" && target == "div#div_notes") {
	    ...
	    $.ajax({
	        url: "{{ URL::route('agency.user.async.updateStatus') }}",
	        dataType : "json",
	        type : "POST",
	    ...
	    $.ajax({
	        url: "{{ URL::route('agency.user.async.updateHintStatus') }}",
	        dataType : "json",
	        type : "POST",
	        data : {hint_id : hintId},
	        success : function(data) {
...
function saveHintNotes(obj) {
    ...
    $.ajax({
        url: "{{ URL::route('agency.job.async.saveHintNotes') }}",
        dataType : "json",
        type : "POST",
...
function sendVIInterview(obj) {
    ...
    $.ajax({
        url: "{{ URL::route('agency.job.async.sendInterview') }}",
        dataType : "json",
        type : "POST",
...
function saveCompanyApplyNotes(obj) {
    ...
    $.ajax({
        url: "{{ URL::route('agency.profile.async.saveApplyNote') }}",
        dataType : "json",
        type : "POST",
        data : {apply_id : applyId, notes : notes},
        success : function(data) {
...
$("button#js-btn-send-applyMessage").click(function() {
    ...
    $.ajax({
        url:"{{ URL::route('agency.profile.async.sendMessage') }}",
        dataType : "json",
        type : "POST",
        data : {apply_id : applyId, message : message},
        success : function(data){
