            ...
            <div class="form-group">
	    	    <div class="col-sm-12 margin-top-lg">
                    <ul class="nav nav-tabs custom-nav-tabs text-center">
                        ...
                        <li class=""><a href="#tab-rejection-template" data-toggle="tab" class="text-uppercase"><i class="fa fa-paper-plane-o"></i> {{ trans('company.email_template') }}</a></li>
                						...
                						<div class="row margin-top-sm">
                							<div class="form-group margin-top-xs">
                								<div class="col-sm-7 col-sm-offset-5">
                				                    {{ Form::checkbox('is_published', $company->is_published, $company->is_published, ['class' => 'checkbox-normal', 'id' => 'is_published', 'style' => 'height: 19px !important;']) }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        @if ($key == 'apply_rejection_content')
                                                            {{ Form::textarea($key, $company->{$key}, ['class' => 'form-control']) }}
                                                        @else
                                                            {{ Form::text($key, $company->{$key}, ['class' => 'form-control']) }}
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" value="{{ HTTP_PATH.'widget/'.$company->slug }}" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row margin-top-sm">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group demo2">
                                                            <input type="text" value="{{ ($company->overlay_color == '') ? 'rgba(0, 82, 208, 0.9)' : $company->overlay_color  }}" class="form-control" name="overlay_color" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9 col-sm-offset-3">
                                                            <div class="row margin-top-sm">
                                                                <div class="form-group margin-top-xs">
                                                                    <div class="col-sm-12">
                                                                        {{ Form::checkbox('is_show', $company->is_show, $company->is_show, ['class' => 'checkbox-normal', 'id' => 'is_show', 'style' => 'height: 19px !important;']) }}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9 col-sm-offset-3">
                                                            <div class="row margin-top-sm">
                                                                <div class="form-group margin-top-xs">
                                                                    <div class="col-sm-12">
                                                                        {{ Form::checkbox('hide_bids_iframe', $company->hide_bids_iframe, $company->hide_bids_iframe, ['class' => 'checkbox-normal', 'id' => 'hide_bids_iframe', 'style' => 'height: 19px !important;']) }}
                                                                        <label class="control-checkbox"> Hide bids on job list page</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9 col-sm-offset-3">
                                                            <div class="row margin-top-sm">
                                                                <div class="form-group margin-top-xs">
                                                                    <div class="col-sm-12">
                                                                        {{ Form::checkbox('hide_bonus_iframe', $company->hide_bonus_iframe, $company->hide_bonus_iframe, ['class' => 'checkbox-normal', 'id' => 'hide_bonus_iframe', 'style' => 'height: 19px !important;']) }}
                                                                        <label class="control-checkbox"> Hide bonus on job list page</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9 col-sm-offset-3">
                                                            <div class="row margin-top-sm">
                                                                <div class="form-group margin-top-xs">
                                                                    <div class="col-sm-12">
                                                                        {{ Form::checkbox('hide_salary_iframe', $company->hide_salary_iframe, $company->hide_salary_iframe, ['class' => 'checkbox-normal', 'id' => 'hide_salary_iframe', 'style' => 'height: 19px !important;']) }}
                                                                        <label class="control-checkbox"> Hide salary on job list page</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-8 col-sm-offset-2 video-interview-screen">
                                                <div class="col-sm-10 col-sm-offset-1">
                                                    <div class="video-interview-header">
                                                        <img src="{{ $company->video_interview_logo == '' ? HTTP_LOGO_PATH.'default_company_logo.gif' : HTTP_LOGO_PATH.$company->video_interview_logo }}" class="video-interview-company-logo" id="img-interview-logo">
                                                    ...
                                                    <div class="video-interview-body">
                                                        ...
                                                        <div class="video-interview-body-content">
                                                            <img src="{{ $company->video_interview_image == '' ? HTTP_COMPANY_PHOTO_PATH.'default.jpg' : HTTP_COMPANY_PHOTO_PATH.$company->video_interview_image }}" class="video-interview-company-image" id="img-interview-image">
                                                            <div class="video-interview-text-box">
                                                                <textarea class="video-interview-text" name="video-interview-text">{{ $company->video_interview_text == '' ? str_replace("<br/>", "\n", "Vacancy<br/>Cammio Video Pitch") : $company->video_interview_text }}</textarea>
                                                            </div>
                                                ...
                                                <img src="{{ $company->video_interview_background != '' ? HTTP_COMPANY_PHOTO_PATH.$company->video_interview_background : '' }}" class="video-interview-screen-background" id="img-interview-background">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-8 col-sm-offset-2">
                                                ...
                                                <div class="margin-top-xs">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($company->video_interview_end != '') $interviewText = $company->video_interview_end;
                                                    ?>
