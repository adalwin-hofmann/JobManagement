...
<div class="gray-container padding-bottom-xs">
    <div class="container" style="min-height: 358px;">
        <div class="row margin-bottom-sm">
            @if (count($users) > 0)
                @foreach ($users as $user)
                <div class="row margin-top-xs" id="div_job">
                    <div class="row table-job-row padding-top-sm padding-bottom-xs" id="div_user">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-sm-2 text-center">
                                    ...
                                    <div class="row">
                                        @foreach ($user->shares as $item)
                                            <span class="label" style="background-color: #009cff">Shared By {{ $item->agency->name }}</span>
                                        @endforeach
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 margin-top-xxs">
                                                    <textarea class="form-control" name="notes" rows="3" id="js-textarea-user-notes" data-id="{{ $user->id }}" placeholder="Note...">{{ $user->shareNoteByCompany($company->id) }}</textarea>
                                                </div>
                                                <div class="col-sm-12 text-center margin-top-xs">
                                                    <button class="btn btn-success btn-sm btn-home" onclick="saveShareUserNotes(this)" style="display: none;" id="js-button-saveNote"><i class="fa fa-save"></i> Save Note</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('custom-scripts')
    ...
    @include('js.company.user.shared')
@stop