                                        ...
                                        @foreach ($user->applies as $apply)
                                            @if ($apply->job->company_id == $company->id || $apply->job->sharedToCompany($company->id))
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <p>
                                                            <a href="{{ URL::route('company.job.view', $apply->job->slug) }}">{{ $apply->job->name }}</a> &nbsp @if ($apply->job->sharedToCompany($company->id)) <span class="label" style="background-color: #009cff">Shared</span>  @endif
                                                        </p>
