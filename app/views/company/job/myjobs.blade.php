...
<main class="bs-docs-masthead gray-container padding-top-xs padding-bottom-xs" role="main">
    ...
    <div class="container padding-bottom-sm" style="background: white;">
        ...
        <div class="col-sm-3">
            @include("company.job.leftMyJobs")
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    <a href="{{ URL::route('company.job.view', $item->slug) }}"><b>{{ $item->name }}</b></a>
                                    <br>
                                ...
                                <td class="text-center">
                                    <a href="{{ URL::route('company.job.view', $item->slug) }}" class="btn btn-success btn-sm btn-home">{{ trans('job.view') }}</a>
                                </td>
                            </tr>
                                                    ...
                                                    @foreach($item->applies as $apply)
                                                        ...
                                                        <div class="row padding-top-xxs padding-bottom-xxs">
                                                            ...
                                                            <div class="col-sm-4 row" style="position: relative;">
                                                                <input id="input-rate" name="rating" class="rating" data-size="xs" data-default-caption="{rating}" data-star-captions="{}" style="float: left;" value="{{ $apply->score }}" onchange="showSaveButton(this)" @if ($company->is_admin != 1 && $item->company_id != $company->id) disabled @endif>
                                                ...
                                                <div class="alert alert-success alert-dismissibl fade in">
                                                    ...
                                                    @foreach($item->hints as $hint)
                                                        ...
                                                        <div class="row padding-top-xxs padding-bottom-xxs">
                                                            ...
                                                            <div class="col-sm-4 row" style="position: relative;">
                                                                <input id="input-rate" name="rating" class="rating" data-size="xs" data-default-caption="{rating}" data-star-captions="{}" style="float: left;" value="{{ $hint->score }}" onchange="showSaveButton(this)" @if ($company->is_admin != 1 && $item->company_id != $company->id) disabled @endif>
                        ...
                        <div id="div_user">
                            <div class="row padding-top-xs padding-bottom-xs" style="position: relative;">
                                @if ($user->shares()->count() > 0)
                                    <img src="{{ HTTP_IMAGE_PATH.'shared-marker.png' }}" class="shared-marker" style="left: 15px; height: 73px;"/>
                                @endif
                                ...
                                <div class="col-sm-3" style="padding-top: 2px;">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input id="input-rate" name="rating" class="rating" data-size="xs" data-default-caption="{rating}" data-star-captions="{}" style="float: left;" value="{{ count($user->scores()->where('company_id', $company->id)->get()) > 0 ? $user->scores()->where('company_id', $company->id)->firstOrFail()->score : 0  }}" onchange="showSaveButton(this)" @if ($company->is_admin != 1 && $item->company_id != $company->id) disabled @endif>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="alert alert-success alert-dismissibl fade in">
                                            ...
                                            @foreach($user->applies as $apply)
                                                @if ($apply->job->company->id == $company->id)
                                                <p>
                        ...
                        <div id="div_user">
                            <div class="row padding-top-xs padding-bottom-xs" style="position: relative;">
                                ...
                                <div class="col-sm-3" style="padding-top: 2px;">
                                    ...
                                    <div class="row" style="position: relative;">
                                        <input id="input-rate" name="rating" class="rating" data-size="xs" data-default-caption="{rating}" data-star-captions="{}" style="float: left;" value="{{ count($item->user->scores()->where('company_id', $company->id)->get()) > 0 ? $item->user->scores()->where('company_id', $company->id)->firstOrFail()->score : 0  }}" onchange="showSaveButton(this)" @if ($company->is_admin != 1 && $item->company_id != $company->id) disabled @endif>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="row margin-top-xs">
                                                                            ...
                                                                            <?php
                                                                                $myNotes = '';
                                                                                if ($item->responses[$key]->notes()->where('company_id', $company->id)->get()->count() > 0) {
                                                                                    $myNotes = $item->responses[$key]->notes()->where('company_id', $company->id)->firstOrFail()->notes;
                                                                                }
                                                                            ?>
                                                                            <div class="col-sm-12">
