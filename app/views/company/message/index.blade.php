                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ URL::route('company.job.view', $value->job->slug) }}">{{ $value->job->name }}</a>
                            @endif
                        ...
                        <td class="text-center">
                            @if ($value->job_id != NULL)
                            <a href="{{ URL::route('company.message.detail', array($company->slug, $value->user_id, $value->job_id)) }}" class="btn btn-primary btn-sm">Detail</a>
                            @else
                            <a href="{{ URL::route('company.message.detail', array($company->slug, $value->user_id)) }}" class="btn btn-primary btn-sm">Detail</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
