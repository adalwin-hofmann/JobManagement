...
@section ('body')
    <div class="container">
        <div class="interview-body">
            <img src="{{ $company->video_interview_image == '' ? HTTP_COMPANY_PHOTO_PATH.'default.jpg' : HTTP_COMPANY_PHOTO_PATH.$company->video_interview_image }}" class="interview-company-image">
            <div class="interview-body-content">
                <div class="col-sm-12 text-right">
                    {{ date('d/m/Y') }}
                </div>

                <div class="col-sm-12 interview-body-text">
                    <label>{{ str_replace("\r\n", "<br/>", $company->video_interview_text) }}</label>
                </div>
    ...
    <?php
        $interviewText = "Thank you for your responses. <br/>We will review it and will let you know.<br/>Best regards.";
        if ($company->video_interview_end != '') {
            $interviewText = str_replace("\n", "<br/>", $company->video_interview_end);
        }
    ?>
    <div class="vi-end-box">
        <div class="vi-end-text-box">
            {{ $interviewText }}
        </div>
    </div>
@stop
...
@section('footer')
    <div class="container">
        <div class="interview-footer text-center">
            <a class="btn blue" href="{{ HTTP_PATH }}">Continue</a>
        </div>
    </div>
