...
class UserMessageToCompany {
    ...
    public function fire($j, $d)
    {
        ...
        $email = EmailModel::findByCode('ET27');
        ...
        $body = str_replace('{message_link}', URL::route('company.message.detail', array($company->slug, $user->id)), $body);
