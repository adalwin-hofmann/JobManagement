var FormEditable = function () {
    ...
    var initEditables = function () {
        ...
        $('a#applylink').editable({
            url: '/post',
            type: 'text',
            pk: 1,
            name: 'applylink',
            title: 'Enter apply link address'
        });
        ...
        $('a#userpreviousjobs').editable({
            url: '/post',
            type: 'text',
            pk: 1,
            name: 'userpreviousjobs',
            title: 'Enter previous jobs'
        });
